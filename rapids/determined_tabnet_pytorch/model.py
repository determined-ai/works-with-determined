...
class RossmanTrial(PyTorchTrial):
    def __init__(self, context: PyTorchTrialContext):
        ...
        path_train = f"https://{S3_BUCKET}.s3-us-west-2.amazonaws.com/{S3_KEY}/train-large.csv"
        path_valid = f"https://{S3_BUCKET}.s3-us-west-2.amazonaws.com/{S3_KEY}/val-large.csv"
        path_store = f"https://{S3_BUCKET}.s3-us-west-2.amazonaws.com/{S3_KEY}/store.csv"

        #path_train = f"s3://{S3_BUCKET}/{S3_KEY}/train-large.csv"
        #path_valid = f"s3://{S3_BUCKET}/{S3_KEY}/val-large.csv"
        #path_store = f"s3://{S3_BUCKET}/{S3_KEY}/store.csv"
